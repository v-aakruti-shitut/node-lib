...
const pubsub = new Redis(REDIS_URI, { redisOptions: Redis.clientOptions(false), pubsub: true, dnsLookup: false, tls: false, log: new Log.Empty() })
...
describe('redis tests', () => {
  ...
  test('key operations - set, mset, incr. get should return string, mget should return array', async (done) => {
