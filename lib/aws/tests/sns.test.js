...
describe('Testing SNS', () => {
  test('constructor should establish client', async (done) => {
  ...
  test('SNS.send should send SMS and get response', async (done) => {
  ...
  test('SNS.send with no subject should send SMS and get response', async (done) => {
    const spy = jest.spyOn(sns.client, 'publish')
    const res = await sns.send(
      '+6599999999',
      'This is a valid message'
