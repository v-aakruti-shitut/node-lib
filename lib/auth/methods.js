...
class Methods {
  ...
  async refreshToken () { throw common.error('AUTH', new Error('REFRESH_TOKEN_NOT_IMPLEMENTED')) }

  async generateToken () { throw common.error('AUTH', new Error('GENERATE_TOKEN_NOT_IMPLEMENTED')) }

  async isTokenValid () { throw common.error('AUTH', new Error('TOKEN_VALID_NOT_IMPLEMENTED')) }

  async isOperationAllowed () { throw common.error('AUTH', new Error('IS_ALLOWED_NOT_IMPLEMENTED')) }

  async getMetadata () { throw common.error('AUTH', new Error('GET_METADATA_NOT_IMPLEMENTED')) }

  async getScope () { throw common.error('AUTH', new Error('GET_SCOPE_NOT_IMPLEMENTED')) }
