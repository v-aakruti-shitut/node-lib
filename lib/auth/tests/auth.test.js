...
describe('auth tests', () => {
  ...
  it('creating new methods without config should return error', (done) => {
    try { new Methods() } catch (e) { expect(e).toEqual(new Error('[AUTH_METHODS] NO_CONFIG')) } // eslint-disable-line
    done()
  })
  it('creating new methods without options log should have empty log instance', (done) => {
    const m = new Methods({})
    expect(m.log.type).toEqual('empty')
    done()
  })
  it('generateToken should return token object, google return error', async () => {
  ...
  it('invalid functions should return error', async () => {
  ...
  it('invalid functions which are overriden should return error', async () => {
  ...
  it('isTokenValid should return object with at least id and domain', async () => {
    // for google
  ...
  it('isOperationAllowed should return boolean or error', async () => {
    // for google
  ...
  it('getMetadata should return object or error', async () => {
    // for google
  ...
  it('empty getMetadata http response should be handled accordingly', async () => {
    // for google
  ...
  it('no payload to utils.http when form options is set should work', async () => {
